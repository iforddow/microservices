...
/*
* A service class for session token storage in Redis.
*
* @author IFD
* @since 2025-10-29
* */
...
@Service
public class RedisSessionTokenService {
    ...
    * */
    private String getTokenPrefix() {
        return  servicePrefix + "session.token:";
    }
    ...
    * */
    private String getUserTokensPrefix() {
        return  servicePrefix + "user.session.tokens:";
    }

    /**
     * A method to store a session token in the redis
     * database.
     *
     * @author IFD
     * @since 2025-07-20
